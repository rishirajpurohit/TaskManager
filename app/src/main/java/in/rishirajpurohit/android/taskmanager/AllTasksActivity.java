...
import in.rishirajpurohit.android.taskmanager.Adapter.TasksAdapter;
...
public class AllTasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TasksDbHelper db = new TasksDbHelper(this);



        final TasksAdapter tasksAdapter = new TasksAdapter(this,db.getAllTasks());
        ...
        lv_tasks.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Toast.makeText(AllTasksActivity.this, "Loding Task at", Toast.LENGTH_SHORT).show();
